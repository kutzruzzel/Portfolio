        ...
        <header className="App-header">
          ...
          <section className="intro">
            ...
            <AnimatedPage>
              ...
              <div className="proj1">
                <div className="proj1image"></div>
                <div className="proj1name">
                  <h1 className="Name1">EzMoney Web App</h1>

                  <Link
                    to="https://github.com/Kutz-S/MoneyWalletWeb"
                    target="_blank"
                  >
                    <div>
                ...
                <p className="proj1footer">React - Styled Components</p>
              </div>
            </AnimatedPage>
          </section>
